          ...
          _card(
            ...
            children: [
              _tile(
                context,
                'Theme',
                _settings.themeMode == ThemeMode.light ? 'Light' : 'Dark',
          ...
          _card(
            ...
            children: [
              _storageTile(
                context,
                'Clear Cache',
                'Frees up space by removing temporary files',
                _loadingStorage
                    ? '...'
  ...
  Widget _tile(BuildContext context, String title, String subtitle,
    ...
    return ListTile(
      ...
      subtitle: Text(subtitle,
          style: GoogleFonts.spaceGrotesk(
              color: colors.onSurface.withValues(alpha: 0.5), fontSize: 12)),
      trailing: Icon(Icons.chevron_right,
          color: colors.onSurface.withValues(alpha: 0.5)),
    );
  }

  Widget _storageTile(BuildContext context, String title, String subtitle,
  ...
  Future<void> _confirmClearCache(BuildContext context) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Downloaded Quran text, translations, prayer times and audio files will be removed.',
        ),
        actions: [
          TextButton(
